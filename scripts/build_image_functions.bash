...
function build_desktop() {
    ...
    build_single_package_image $rosdistro $from $nameandtag ros-$rosdistro-desktop
}
...
function build_desktop_full() {
    ...
    build_single_package_image $rosdistro $from $nameandtag ros-$rosdistro-desktop-full
}

function ros2_build_perception() {
    rosdistro=$1
    from=$2
    nameandtag=$3

    build_single_package_image $rosdistro $from $nameandtag ros-$rosdistro-perception
}
...
function ros2_build_simulation() {
    ...
    build_single_package_image $rosdistro $from $nameandtag ros-$rosdistro-simulation
}